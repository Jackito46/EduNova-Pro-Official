-- Migration to fix the ON CONFLICT constraint error in classes table
-- This modifies seed_school_data to match the classes_school_name_campus_unique constraint on (school_id, campus_id, name)
