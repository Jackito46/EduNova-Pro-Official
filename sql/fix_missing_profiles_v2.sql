-- ==============================================================================
-- SCRIPT DE RÉPARATION DES PROFILS UTILISATEURS (V2)
-- À EXÉCUTER DANS LE SQL EDITOR DE SUPABASE
-- ==============================================================================

-- 1. Remplacement du trigger handle_new_user avec le bon cast (::user_role)
...
BEGIN
  ...
  -- IMPORTANT: On utilise ::user_role pour caster le texte vers l'enum
...
-- 2. Création d'une fonction pour synchroniser les profils manquants avec le bon cast
...
BEGIN
  ...
  LOOP
    ...
    EXCEPTION WHEN OTHERS THEN
      -- Ignorer les erreurs individuelles pour continuer la boucle
