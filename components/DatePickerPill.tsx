      ...
      <div className="flex items-center gap-1.5 w-full">
        ...
        {showQuickArrows && (
          <button
            ...
            className="p-2 sm:p-2.5 bg-slate-50 hover:bg-slate-100 active:bg-slate-200 text-slate-700 hover:text-slate-900 rounded-xl border border-slate-200 hover:border-slate-300 transition-all shrink-0 active:scale-95 disabled:opacity-50"
          >
        ...
        <button
          ...
          disabled={disabled}
          className={`
            w-full flex items-center justify-between gap-2.5 text-left transition-all outline-none select-none
            ${variant === 'field' 
              ? 'px-3.5 py-2 sm:py-2.5 bg-slate-50 hover:bg-slate-100/90 focus:bg-white text-xs font-bold text-slate-900 rounded-xl border border-slate-200 shadow-2xs hover:border-slate-300' 
              : 'px-3.5 py-2 bg-white hover:bg-slate-50 text-xs font-bold text-slate-800 rounded-full border border-slate-200 shadow-xs hover:border-slate-300'
            }
          ...
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
                <span className="truncate text-xs font-black text-slate-900 capitalize">
                  {formattedDisplay}
                </span>
                {showTodayBadge && isToday && (
                  <span className="shrink-0 px-2 py-0.5 text-[10px] font-black bg-emerald-100 text-emerald-800 rounded-md border border-emerald-200/80">
                    Aujourd'hui
                  </span>
                )}
              </div>
      ...
      {isOpen && (
        <div 
          className={`
            ...
            w-80 sm:w-[340px] max-w-[calc(100vw-2rem)] bg-white rounded-3xl shadow-2xl border border-slate-200
            p-3.5 sm:p-4 z-[100] animate-in fade-in zoom-in-95 duration-150 select-none
          `}
        >
          {/* Quick Presets Bar */}
          {showShortcuts && (
